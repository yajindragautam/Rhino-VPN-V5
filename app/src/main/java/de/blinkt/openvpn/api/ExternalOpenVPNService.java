...
public class ExternalOpenVPNService extends Service implements StateListener {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && Intent.ACTION_UNINSTALL_PACKAGE.equals(intent.getAction())){
                ...
                if (ProfileManager.isTempProfile()) {
                    if (Objects.requireNonNull(intent.getPackage()).equals(vp.mProfileCreator)) {
                        if (mService != null)
                            try {
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        @Override
        public APIVpnProfile addNewVPNProfileWithExtras(String name, boolean userEditable, String config, Bundle extras) {
            ...
            try {
                ...
                ProfileManager.saveProfile(ExternalOpenVPNService.this, vp);
