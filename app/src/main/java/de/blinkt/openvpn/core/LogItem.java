...
public class LogItem implements Parcelable {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LogItem other))
            return obj.equals(this);

        return Arrays.equals(mArgs, other.mArgs) &&
                ((other.mMessage == null && Objects.equals(mMessage, other.mMessage)) ||
    ...
    private String getMobileInfoString(Context c) {
        ...
        try {
            ...
            Signature raw = Objects.requireNonNull(c.getPackageManager().getPackageInfo(c.getPackageName(), PackageManager.GET_SIGNATURES).signatures)[0];
