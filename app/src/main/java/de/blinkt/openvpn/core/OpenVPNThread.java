...
public class OpenVPNThread implements Runnable {
        ...
        try {
            ...
            while (true) {
                ...
                if (m.matches()) {
                    ...
                    VpnStatus.LogLevel logStatus = getLogLevel(flags);

                    if (Objects.requireNonNull(msg).startsWith("MANAGEMENT: CMD"))
    ...
    private static VpnStatus.LogLevel getLogLevel(int flags) {
