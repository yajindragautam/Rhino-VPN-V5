...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    private final OrbotHelper.StatusCallback statusCallback = new OrbotHelper.StatusCallback() {
        ...
        public void onStatus(Intent statusIntent) {
            ...
            for (String key : Objects.requireNonNull(Objects.requireNonNull(statusIntent.getExtras())).keySet()) {
    ...
    public void run() {
        ...
        try {
            ...
            if (!Objects.requireNonNull(e.getMessage()).equals("socket closed") && !e.getMessage().equals("Connection reset by peer"))
                VpnStatus.logException(e);
        }
        synchronized (active) {
            active.remove(this);
    ...
    /** @noinspection JavaReflectionMemberAccess, DataFlowIssue */ //! Hack O Rama 2000!
        ...
        switch (needed) {
            ...
            */
            ...
            case "IFCONFIG":
                ...
                mtu = Integer.parseInt(ifconfigparts[2]);
