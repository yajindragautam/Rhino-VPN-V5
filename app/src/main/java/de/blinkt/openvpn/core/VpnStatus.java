...
public class VpnStatus {
    ...
    public static String getLastCleanLogMessage(Context c) {
        ...
        if (Objects.requireNonNull(mLastLevel) == ConnectionStatus.LEVEL_CONNECTED) {
...
*/
    ...
    public static void initLogCache(File cacheDir) {
        final HandlerThread mHandlerThread = new HandlerThread("LogFileWriter", Thread.MIN_PRIORITY);
